...
<div class="signup__container">
  <div class="container__child signup__thumbnail">
    <div class="thumbnail__logo">
      ...
      <h1 class="logo__text">Jim Electric</h1>
    </div>
    <div class="thumbnail__content text-center">
      <h1 class="heading--primary">Welcome to Jim Electric.</h1>
  ...
  <div class="container__child signup__form">
     ...
     <?php Session::put('message',null);} ?>    
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="text" name="name" id="username" placeholder="jName" required />
      </div>
      <div class="form-group">
        <label for="username">Mobile</label>
        <input class="form-control" type="number" name="mobile" id="mobile" placeholder="01........" required />
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input class="form-control" type="password" name="password_confirmation" id="passwordRepeat" placeholder="********" required />
      </div>
      <div class="form-group">
        <label for="passwordRepeat">Image</label>
