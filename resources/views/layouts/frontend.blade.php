            ...
            <div class="container px-6 py-3 mx-auto">
                ...
                <nav  class="p-6 mt-4 text-white bg-black sm:flex sm:justify-center sm:items-center">
                    <div class="flex flex-col sm:flex-row">
                        <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" href="{{ url('/dashboard') }}">Home</a>
                        <a class="mt-3 hover:underline sm:mx-3 sm:mt-0" style="color:red;"
						 @if ($message = Session::get('bnm'))
                         href="{{ url($message) }}"
                      @endif
