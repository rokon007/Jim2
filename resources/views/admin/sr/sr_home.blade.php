...
@section('admin_content')
 ...
 <div class="sl-mainpanel">
    <nav class="breadcrumb sl-breadcrumb">
      <a class="breadcrumb-item" href="index.html">SR : {{Auth::user()->name}}</a>
        ...
        <div class="col-sm-6 col-xl-3">
          <div class="card pd-20 bg-primary">
            <div class="d-flex justify-content-between align-items-center mg-b-10">
              <h6 class="tx-25 tx-uppercase mg-b-0 tx-spacing-1 tx-white">আজকের বিক্রয়</h6>
              <a href="" class="tx-white-8 hover-white"><i class="icon ion-android-more-horizontal"></i></a>
            </div><!-- card-header -->
            <div class="d-flex align-items-center justify-content-between">
            <!--  <span class="sparkline2">5,3,9,6,5,9,7,3,5,2</span> -->
              <h3 class="mg-b-0 tx-white tx-lato tx-bold">Tk {{$Totalamount}}</h3>
            </div><!-- card-body -->
            <div class="d-flex align-items-center justify-content-between mg-t-15 bd-t bd-white-2 pd-t-10">
              <div>
                <span class="tx-25 tx-white-6">মোট গ্রাহক</span>
                <h6 class="tx-white mg-b-0">{{$sales_order}}</h6>
              </div>
              <div>
                <span class="tx-25 tx-white-6">মোট কমিশন</span>
